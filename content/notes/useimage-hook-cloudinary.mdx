...
Trying out the `useImage` hook from the `use-cloudinary` library ([repo](https://github.com/domitriusclark/use-cloudinary) | [docs](https://use-cloudinary.netlify.app/)). I copied the sample component code from the [documentation page](https://use-cloudinary.netlify.app/usage/use-image/). Let’s go!
